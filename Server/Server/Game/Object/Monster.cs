...
namespace Server.Game
{
    public class Monster : GameObject
    {
        ...
        //    long serverNowMs = Util.GetTimestampMs();
        //    Player target = GameRoom.FindPlayer(p =>
        //    {
        //        Vector3 playerPos = MovementHelper.PredictPosition(
        //        MovementHelper.PVec3ToVec3(p.ObjectState.Position),
        //        MovementHelper.PVec3ToVec3(p.ObjectState.Velocity),
        //        p.ObjectState.ServerReceivedTime,
        //        serverNowMs
        //        );
        //        Vector3 dir = p.CurrentPos - CurrentPos;
